      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white p-10 rounded-[3rem] shadow-2xl shadow-pink-100/40 border border-gray-100">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-4xl font-black text-gray-900 tracking-tighter mb-2">Join Us</h2>
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400">Create your boutique profile</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button className="group w-full bg-gray-900 text-white h-14 rounded-2xl font-black text-[11px] uppercase tracking-[0.3em] hover:bg-black transition-all shadow-xl shadow-gray-200 flex items-center justify-center gap-3 active:scale-95 mt-2">
          ...
          <div className="mt-10 pt-8 border-t border-gray-50 text-center">
            <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">
              Already a member? <Link to="/login" className="text-pink-600 font-black hover:underline underline-offset-8 ml-1 transition-all">Login Here</Link>
            </p>
          </div>
        </div>
      </div>
